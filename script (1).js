...
function populateBillsDropdowns() {
    ...
    // ★ বারকোড স্ক্যান বা লেখার সাথে অটোমেটিক "Add to Preview" হওয়ার লজিক
    if (prodBarcodeBillInput) {
        prodBarcodeBillInput.oninput = function() {
            ...
            // বারকোড এর সাথে কোনো প্রোডাক্ট মিললে তা অটো অ্যাড হবে
            ...
            if (matchedProduct) {
                ...
                // অটোমেটিক প্রিভিউ তে যোগ করা হচ্ছে
                addToPreview(true);
            }
        };

        // বারকোড স্ক্যানারে Enter কি প্রেস হলেও যাতে অটো-অ্যাড কাজ করে
...
// isAutoScan প্যারামিটার দিয়ে চিহ্নিত করা হবে স্ক্যান করে অটো যোগ হলো নাকি বাটনে ক্লিক করে
function addToPreview(isAutoScan = false) {
    ...
    if(isAbsoluteBillDuplicate) {
        ...
        // অটো-স্ক্যানের সময় কারেন্ট ইনপুট ক্লিয়ার করে দেওয়া হবে
    ...
    // ম্যানুয়ালি ক্লিক করলে এলার্ট দেখাবে, স্ক্যানের ক্ষেত্রে স্মুথলি অটো যোগ হবে
    if(!isAutoScan) {
        alert(`"${prodName}" প্রিভিউ লিস্টে যোগ হয়েছে!`);
    } else {
        // বারকোড ফিল্ডে আবার অটোমেটিক ফোকাস রাখবে যাতে দ্রুত পরের বারকোড স্ক্যান করা যায়
